...
public class MenuAdmin extends MenuUtilizadorAdmin {
    ...
    public MenuAdmin(ClientAdminRemote ligacao, ControladorAdministrador controlador) {
        ...
        opcoes.add(new OpcaoMenu("> Contas", () -> controlador.subMenuContas(this)));
        opcoes.add(new OpcaoMenu("Consultar Denuncias", () -> controlador.consultarDenuncias(this)));
...
//        opcoes.add(new OpcaoMenu("Consultar Item", () -> controlador.consultarItem()));
        opcoes.add(new OpcaoMenu("> Gerir Categorias", () -> controlador.subMenuGerirCategorias(this)));
    }
