...
import advgame.AdvClientRemote;
...
public class AdvRcse {

    static AdvClientRemote adivinha;
    ...
    public static void consultarPontuacao() {
        System.out.println("\nPontuacao actual:" + adivinha.getMyScore());
    }

    public static void consultarTentativas() {
        System.out.println("\nTentativas ate agora: " + adivinha.getMyAttempts());
    }

    public static void consultarHiscores() {
        ArrayList<String> hisc = adivinha.getHiScores();
